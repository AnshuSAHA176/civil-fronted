...
export default function Notifications() {
  ...
  const openRelatedResource = (notification) => {
    if (notification?.complain) {
      navigate(`/officer/complaints/${encodeURIComponent(notification.complain)}`)
    }
  }
    ...
    return (
      <section className="page-section notification-page" aria-busy="true">
        <div className="page-heading">
          ...
          <h1>Notifications</h1>
          <p>Important updates about complaints assigned to you.</p>
        </div>
  ...
  return (
    <section className="page-section notification-page">
      ...
      {notifications.length === 0 ? (
        ...
        <div className="notification-list" aria-label="Officer notifications">
