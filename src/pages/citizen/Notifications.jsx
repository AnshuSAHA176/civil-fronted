...
import { Bell, CheckCircle2, FileText, MessageSquare, RefreshCw } from 'lucide-react'
...
export default function Notifications() {
  ...
  const openRelatedResource = (notification) => {
    if (notification?.complain) {
      navigate(`/citizen/complaints/${encodeURIComponent(notification.complain)}`)
      return
    }

    // RTI details is intentionally not linked yet because RTI routing is a
    // later phase. We never invent a route that has not been implemented.
  }
    ...
    return (
      <section className="page-section notification-page" aria-busy="true">
        <div className="page-heading">
          ...
          <h1>Notifications</h1>
          <p>Important updates about your CivicAI activity.</p>
        </div>
